...
// Worker alineado con pdfjs-dist 5.4.296 (Metro/Expo no soporta ?url ni import.meta).
...
export const PDFSignatureNew: React.FC<PDFSignatureNewProps> = ({ pdfUrl, onSigned }) => {
                ...
                <div className="signature-modal-overlay" onClick={() => setShowSignatureModal(false)}>
                    <div className="signature-modal-fullscreen" onClick={(e) => e.stopPropagation()}>
                        <div className="signature-modal-header">
                            <h3>
                                {signedPdfBlob ? 'Documento Firmado' : 'Revisar y Firmar Contrato'}
                            </h3>
                            <button
                                type="button"
                                className="close-btn"
                            ...
                            <div className="pdf-column">
                                <div className="pdf-preview-scrollable">
                                    ...
                                    <Document
                                        ...
                                        loading={<div className="loading-spinner"><i className="ri-loader-4-line rotating"></i> Cargando PDF...</div>}
                                    >
                                        <div
                                            ...
                                            style={{
                                                cursor: (isSignaturePlaced || signedPdfBlob || !signatureDrawn) ? 'default' : `url(${signatureImageUrl}) 75 37, crosshair`,
                                                position: 'relative'
                                            }}
                                        >
                                            <Page
                                                pageNumber={selectedPage}
                                                width={600} // Slightly smaller for side-by-side
                                    ...
                                    {numPages > 1 && !pdfLoadError && (
                                        <div className="page-controls">
                                            ...
                                            <span>Página {selectedPage} de {numPages}</span>
                                            <button
...
export default PDFSignatureNew;
