...
import { LedgerField } from "../ledger/LedgerUi.native";
...
export default function NominaEmitModalNative({ visible, plantilla, onClose, onSaved }: Props) {
  ...
  return (
    <DsSideModal
      ...
      title="Emitir nómina"
      icon="cash-outline"
      closeDisabled={emitting}
      submitting={emitting}
      submitDisabled={loading}
      submitLabel="Emitir lote"
      onSubmit={() => void emit()}
    >
      <LedgerField label="Prefijo" value={prefijo} onChangeText={setPrefijo} icon="pricetag-outline" />
      <LedgerField label="Inicio periodo" value={inicio} onChangeText={setInicio} icon="calendar-outline" />
      <LedgerField label="Fin periodo" value={fin} onChangeText={setFin} icon="calendar-outline" />
      <LedgerField label="Fecha pago" value={fechaPago} onChangeText={setFechaPago} icon="calendar-outline" />
