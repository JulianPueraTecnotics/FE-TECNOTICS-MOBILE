...
import tecnoticsLogo from "../../../assets/logo.png";
        ...
        <div className="home">
            ...
            <section className="home__hero">
                <div className="home__hero-bg">
                    {HERO_IMAGES.map((src, i) => (
                        <div
                            ...
                            style={{ backgroundImage: `url(${resolveImageUri(src)})` }}
                        />
                    ))}
                ...
                {!isMobile && (
                    <>
                        ...
                        <div
                            key={heroIndex}
                            className="home__hero-progress"
                            style={{ animationDuration: `${CAROUSEL_INTERVAL_MS}ms` }}
                            aria-hidden
                        />
                    </>
                )}
                <div className="home__hero-content">
                    <span className="home__hero-badge">Facturación DIAN</span>
                    <h1>
                        Factura electrónicamente sin
                        <br />
                        complicaciones.
                    </h1>
                    <p>
            ...
            <section className="home section home__features-wrap">
                ...
                <div className="home__section-head">
                    <span className="home__section-eyebrow">Funcionalidades</span>
                ...
                <div className="home__feature-panel">
                    <div className="home__feature-panel__media">
                        <img
                            src={resolveImageUri(img09)}
                            alt="Gestión de facturas en la plataforma"
                            className="home__feature-panel__img"
                        />
                    </div>
                    <ul className="home__feature-panel__list">
            ...
            <section className="home section home__control">
                <div className="home__section-head">
                    <span className="home__section-eyebrow">Gestión</span>
            ...
            <section id="como-funciona" className="home section home__steps-section">
                <div className="home__section-head">
                    <span className="home__section-eyebrow">Proceso</span>
            ...
            <section id="planes" className="home section home__plans-section">
                <div className="home__plans-heading home__section-head">
                    <span className="home__section-eyebrow">Precios</span>
            ...
            <section className="home__faq section">
                <div className="home__section-head">
                    <span className="home__section-eyebrow">Ayuda</span>
            ...
            <footer className="home__footer">
                <div className="home__footer-inner">
                    ...
                    <div className="home__footer-block home__footer-dev">
                        <h3 className="home__footer-title home__footer-dev-label">Desarrollado por</h3>
                        <a href="https://tecnotics.com" target="_blank" rel="noopener noreferrer" className="home__footer-dev-logo" aria-label="Tecnotics">
                            <img src={resolveImageUri(tecnoticsLogo)} alt="Tecnotics - Soluciones corporativas" />
                        </a>
                    </div>
                </div>
            </footer>
