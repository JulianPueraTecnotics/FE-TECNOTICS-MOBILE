...
const LoginPage: React.FC = () => {
    ...
    const handle_credentials = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        if (!turnstileToken) {
            errorToast("Completa la verificación de seguridad antes de continuar.");
            return;
        }
        setLoading(true);
        try {
                    ...
                    {phase === "credentials" ? (
                        ...
                        >
                            <InputComponent
                                ...
                                autoComplete="email"
                            />
                            <FilterField label="Contraseña" htmlFor={passwordFieldId} icon="ri-lock-password-line">
                                <div className="ds-password-wrap">
                                    ...
                                    <button
                                        type="button"
                                        className="ds-password-wrap__toggle"
                        ...
                        >
                            ...
                            <FilterField label="Código de verificación" htmlFor="login-twofa-code" icon="ri-shield-keyhole-line">
                                <FieldControl
                                    id="login-twofa-code"
                                    type="text"
                                    inputMode="numeric"
